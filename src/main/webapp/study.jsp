...
<head>
    ...
    <title>在线试学-米克学院Java视频在线看</title>
    <meta name="keywords" content="培训,IT培训,java培训,大数据培训,前端培训,后台开发,云计算,培训视频">
...
<div class="body-1">
    <img src="img/javasx1.jpg" class="img-responsive center-block" alt="Java视频-免费学-米克学院">
    <div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h2 style="float: right">  <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=775016131&site=qq&menu=yes">了解更多</a></h2>
        </div>
    </div>
    </div>
</div>
