...
<div class="subBody">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                <form action="BaseServlet?method=addSub" method="post" id="form-sub">
                    ...
                    <div class="form-group">
                        <label for="inInfo">课程描述</label><br>
                        <textarea name="info" id="inInfo" placeholder="write some thing for teacher" class="form-control" style=height:300px;">${list.info}</textarea>
                        <span  class="label label-warning" id="check-pass-error"></span>
                    </div>
                </form>
                <button type="submit" class="btn btn-primary" onclick="checkSubject()" style="width: 100%">确认添加</button>
            </div>
            <div class="col-sm-4"></div>
        </div>
    </div>
